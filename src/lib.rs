...
#[proc_macro] pub fn honk(item: proc_macro::TokenStream) -> proc_macro::TokenStream { item }
#[proc_macro] pub fn slip(item: proc_macro::TokenStream) -> proc_macro::TokenStream { item }
